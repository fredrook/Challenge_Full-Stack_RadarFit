...
const UpdateAnyDadosVeiculoService = ({ produto, valor, descricao }, prodId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield productsRepository.update(prodId, {
        produto,
        valor,
        descricao
    });
...
exports.default = UpdateAnyDadosVeiculoService;
